...
class PostureReward(BaseRewardFunction):
    ...
    def __init__(self, config):
        ...
        self.target_dist = getattr(self.config, f'{self.__class__.__name__}_target_dist', 0.5) # 原本是3.0
